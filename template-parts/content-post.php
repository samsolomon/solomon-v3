...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php
		...
		if( have_rows('suggested_posts') ): ?>
			<section class="suggested-posts pt50 pb50">
				<div class="container-post">
					...
					while ( have_rows('suggested_posts') ) : the_row(); ?>
						...
						if( $post_object ):
							...
							?>
						    <div class="mb50">
						    	<h3 class="mb10 text-center"><a href="<?php the_permalink(); ?>" class="remove-underline"><?php the_title(); ?></a></h3>
									<p class="small-caps text-center mb20"><?php echo get_the_date(); ?> / <?php foreach((get_the_category()) as $category) { echo $category->cat_name . ' '; } ?></p>
									<?php the_excerpt(); ?>
